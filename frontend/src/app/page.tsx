...
const FEATURED_REPOS = [
  ...
  {
    url: "https://github.com/SeunOnTech/url-shortener-java",
    html_url: "https://github.com/SeunOnTech/url-shortener-java",
    clone_url: "https://github.com/SeunOnTech/url-shortener-java.git",
    name: "url-shortener-java",
    full_name: "SeunOnTech/url-shortener-java",
    owner: { avatar_url: "https://github.com/SeunOnTech.png" },
    language: "Java",
    description: "Legacy Java Servlet-based URL shortener",
    stargazers_count: 89,
    updated_at: new Date().toISOString(),
    private: false,
    id: 90002,
